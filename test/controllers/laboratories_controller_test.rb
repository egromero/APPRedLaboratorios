...
class LaboratoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create laboratory" do
    assert_difference('Laboratory.count') do
      post laboratories_url, params: { laboratory: { campus: @laboratory.campus, facultad: @laboratory.facultad, nombre: @laboratory.nombre } }
    end
  ...
  test "should update laboratory" do
    patch laboratory_url(@laboratory), params: { laboratory: { campus: @laboratory.campus, facultad: @laboratory.facultad, nombre: @laboratory.nombre } }
